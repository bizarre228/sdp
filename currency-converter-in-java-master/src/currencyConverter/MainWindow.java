	...
	public MainWindow() {
		...
		btnConvert.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				// Use RateManager to get exchange rate
				Double exchangeRate = rateManager.getExchangeRate(nameCurrency1, nameCurrency2);
				...
				if (exchangeRate != null) {
					...
					lblResult.setText("Exchange rate not found.");
				}
			}
		});
